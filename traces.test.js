...
describe('traces.js', () => {
  ...
  describe('Public API', () => {
    it('addTrace should add a trace and update the SVG', () => {
      ...
      const ast = [[{ command: 'M', coordinate: { type: 'element', id: 'test-el', corner: 'tl', modifiers: [] } }]];
    ...
    it('removeTrace should remove a trace from the SVG', () => {
        ...
        const ast2 = [[{ command: 'M', coordinate: { type: 'element', id: 'test-el', corner: 'br', modifiers: [] } }]];
      ...
      it('clearAllTraces should remove all traces', () => {
        ...
        const ast3 = [[{ command: 'M', coordinate: { type: 'element', id: 'test-el', corner: 'tr', modifiers: [] } }]];
